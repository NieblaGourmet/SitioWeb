...
function getTranslatedProducts(langCode) {
    const list = [
        { id: 1, name: "Amanecer Típico", price: 25.00, description: "Una celebración de la tradición costarricense: gallo pinto, huevos al gusto, plátano maduro frito, tortillas de maíz y una cremosa natilla.", img: "./img/menu/desayunotipico.jpg" },
        { id: 2, name: "Omelette", price: 25.00, description: "Huevos frescos de gallina feliz con tu combinación favorita: espinaca, hongos, queso mozzarella, jamón artesanal, tomate cherry y más. Acompañado de pan masa madre y ensalada verde del bosque.", img: "./img/menu/omelette.jpeg" },
        { id: 3, name: "Huevos del Bosque", price: 25.00, description: "Huevos al gusto (fritos, revueltos o pochados), servidos con tocineta crujiente o ensalada de arúgula y kale, más pan masa madre. Simpleza elevada con ingredientes locales.", img: "./img/menu/huevos.jpg" },
        ...
        { id: 5, name: "Tostadas", price: 25.00, description: "Pan brioche artesanal en baño de canela y vainilla, dorado al punto justo. Servidas con frutas frescas, sirope de maple y azúcar glas. Un dulce despertar en el corazón del bosque.", img: "./img/menu/tostadas.jpeg" }
    ];
